...
=begin pod
=TITLE StreamDispatcher::SQMDispatcher
=para Base class for as SAX-like event dispatcher for SQM input

=begin SYNOPSIS
=begin code
class MyClass is StreamDispatcher::SQM {...}
...
=begin DESCRIPTION
This is the base class for as SAX-like event dispatcher. It extends L<StreamParser::Dispatcher::SQM>
...
class StreamDispatcher::SQM is StreamDispatcher::StreamDispatcherBase {
