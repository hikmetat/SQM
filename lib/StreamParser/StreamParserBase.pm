...
=begin SYNOPSIS
=begin code
class MyClass is StreamParser::StreamParserBase {...}
...
=begin METHOD 
=begin code
StreamParser::BaseSubclass.=new( :input( StreamBuffer $input ) )
=end code
I<new()> creates an instance of B<StreamParser::Base>
...
=begin METHOD 
=begin code
StreamParser::BaseSubclass.parse()
=end code
...
=begin METHOD
I<process()> is a private method stub of B<StreamParser::Base> and must be implemented by a subclass.
...
class StreamParser::StreamParserBase {
	...
	has Utilities::StreamBuffer $.stream-buffer is rw;		
